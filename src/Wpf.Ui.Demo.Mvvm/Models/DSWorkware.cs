...
public class DSWorkwareItem
{
    ...
    [Description("重复数据集")]
    public List<DSWorkwareArea>? DSWorkwareAreas { get; set; } = new List<DSWorkwareArea>();

    [Description("标准压力数值")]
    public float StandardPressure { get; set; }
    [Description("标准温度数值")]
    public float StandardTemperature { get; set; }
